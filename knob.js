...
class SynthKnob extends HTMLElement {
  ...
  constructor() {
    ...
    this._root.innerHTML = `
      <style>
        ...
        svg {
          ...
          :host(:hover) #ring {
            fill: var(--accent-color, #7cff7c7f);    
          }    
    ...
    <path id="ring" d="M74.0298 48.8872C74.0298 64.3512 61.4938 76.8872 46.0298 76.8872C30.5658 76.8872 18.0298 64.3512 18.0298 48.8872C18.0298 33.4233 30.5658 20.8872 46.0298 20.8872C61.4938 20.8872 74.0298 33.4233 74.0298 48.8872Z" fill="url(#paint1_linear_15_165)"/>
    </g>
    <g clip-path="url(#paint2_angular_15_165_clip_path)" data-figma-skip-parse="true"><g transform="matrix(-0.0161888 0.0163378 -0.0163378 -0.0161888 46.0298 48.8872)"><foreignObject x="-1475.69" y="-1475.69" width="2951.37" height="2951.37"><div xmlns="http://www.w3.org/1999/xhtml" style="background:conic-gradient(from 90deg,rgba(64, 64, 64, 1) 0deg,rgba(56, 56, 56, 1) 90deg,rgba(64, 64, 64, 1) 180deg,rgba(56, 56, 56, 1) 270deg,rgba(64, 64, 64, 1) 360deg);height:100%;width:100%;opacity:1"></div></foreignObject></g></g>
